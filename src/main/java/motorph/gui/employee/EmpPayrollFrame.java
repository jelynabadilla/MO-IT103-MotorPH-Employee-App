...
public class EmpPayrollFrame extends JFrame {
    ...
    private static final DecimalFormat df = new DecimalFormat("#,##0.00"); // Format for currency display
    ...
    private void populateMonthComboBox() {
        ...
        // Get available months for the logged-in employee
    ...
    // Calculates and displays payroll for the logged in employee based on selected options
    private void calculateAndDisplayPayroll() {
        ...
        try {
            // Use the logged in employee ID directly
            ...
            // Convert week index to a number 
            ...
            // Call the payroll calculation for the specific employee
    ...
    // Updates the employee details text area with current employee info
    ...
    private YearMonth parseYearMonth(String monthString) {
        // Handle empty or placeholder string
