...
public class MotorPH {
    ...
    private static void handleFieldUpdate(Scanner scanner, String choice, Employee employee) {
        switch (choice) {
            ...
            case "3": employee.setBirthday(scanner.nextLine()); break;
            case "4": employee.setAddress(scanner.nextLine()); break;
            case "5": employee.setPhoneNumber(scanner.nextLine()); break;
            case "6": employee.setBasicSalary(Double.parseDouble(scanner.nextLine())); break;
    ...
    /**
     * Displays and handles Attendance Management Menu
     */
     ...
     * This method ensures that users can view attendance data for a specific employee.
     */
    private static void viewEmployeeAttendance(Scanner scanner, FileHandler fileHandler) {
        ...
        /*
        Filter the attendance record for the specified employee
        */
     ...
     * This allow users to narrow down records to a specific month
     */
